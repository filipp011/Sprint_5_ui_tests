...
class TestActualityUser:
    def test_user_registration_actuality(self, driver):
        ...
        driver.find_element(*Alllocarots.INPUT_EMAIL).send_keys("fil.nis61@gmail.com")
        # Ввод пароля в поле пароль
        driver.find_element(*Alllocarots.INPUT_PASSWORD).send_keys("5555")
        # Повторный ввод пароля в поле повторить пароль
        driver.find_element(*Alllocarots.REPEAT_PASSWORD).send_keys("5555")
