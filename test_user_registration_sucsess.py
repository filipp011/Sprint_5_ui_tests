...
class TestFirstRregistration:
    ...
    def test_user_registration_sucsess(self,driver,unique_email):
        ...
        driver.find_element(*Alllocarots.INPUT_EMAIL).send_keys(unique_email)
        # Ввод пароля в поле пароль
        driver.find_element(*Alllocarots.INPUT_PASSWORD).send_keys("558852")
        # Повторный ввод пароля в поле повторить пароль
        driver.find_element(*Alllocarots.REPEAT_PASSWORD).send_keys("558852")
